                  ...
                  return IconButton(
                    onPressed: () {
                      if (_textfieldController.text.isNotEmpty) {
                        ref.invalidate(searchCharactersProvider);
                        ref.read(searchCharactersProvider.notifier).mapEventsToState(
                              SearchedTextChanged(
                  ...
                  return IconButton(
                    onPressed: () {
                      if (_textfieldController.text.isNotEmpty) {
                        ...
                        ref.invalidate(searchCharactersProvider);
                        ref.read(searchCharactersProvider.notifier);
                      }
                    },
                    icon: const Icon(
                      Icons.close,
